...
<head>
    <meta charset="utf-8">
    <title>Aww, looks like something went wrong.</title>
    ...
    <style type="text/css">
        ...
        @keyframes mouth {
            0% {
                d: path("M1499.33,2326.51c68.62,150.15,334.2,171.14,415.73,1.61");
            }
            20% {
                d: path("M1499.33,2326.51c68.62,150.15,334.2,171.14,415.73,1.61");
            }
...
<body>
<div class="container">
    <div class="sad-panda js-svg-animation">
        <svg class="sad-panda-svg" id="panda" xmlns="http://www.w3.org/2000/svg" viewBox="-500 0 4558.64 3058.64">
            <g class="static">
                <path d="M1832.48,2076.65H1603.89c-25.76,0-51.52-16.09-61.18-41.85l-48.29-109.47c0-32.19,25.76-54.73,54.73-54.73h344.5c32.2,0,54.74,25.76,54.74,54.73l-41.86,99.81C1893.65,2057.34,1864.68,2076.65,1832.48,2076.65Z"/>
                <path d="M2727.53,492.6C2421.67,180.3,2064.29,0,1732.67,0,1330.22,0,972.84,186.74,705.61,463.63,514.23,663,327.5,1012.87,251.65,1278.19a1536.38,1536.38,0,0,0-48.3,379.91c0,379.92,154.54,734.08,437.87,994.87s672.9,405.67,1091.45,405.67S2540.8,2913.76,2824.12,2653,3262,2038,3262,1658.1c0-119.12-19.32-244.69-57.95-370.25C3095.3,900.28,2848.75,622.15,2727.53,492.6ZM1732.67,2920.2c-804.9,0-1394.09-566.66-1394.09-1265.32S927.77,135.22,1732.67,135.22c653.58,0,1394.1,824.23,1394.1,1519.66S2537.58,2920.2,1732.67,2920.2Z"/>
            </g>
            <g class="right">
                <path id="og" d="M3164.93,1294.69,2731.71,503.86c36.66-33.89,79.33-62.09,128-81.79,225.81-91.4,486.62,26.6,582.54,263.57s-9.39,503.15-235.21,594.55A427.59,427.59,0,0,1,3164.93,1294.69Z"/>
            </g>
            <g class="left">
                <path id="og-2" data-name="og" d="M312.77,1294.69,746,503.86c-36.66-33.89-79.33-62.09-128-81.79-225.81-91.4-486.62,26.6-582.53,263.57s9.39,503.15,235.2,594.55A428.49,428.49,0,0,0,312.77,1294.69Z"/>
            </g>
            <g class="eyes">
                <path id="_Path_" data-name="&lt;Path&gt;" d="M1180.72,1307.17c-183.52,0-489.38,260.78-486.16,447.52,0,183.52,148.1,334.84,334.84,334.84,183.52,0,334.84-148.1,334.84-334.84S1367.46,1307.17,1180.72,1307.17Z"/>
                <path id="_Path_2" data-name="&lt;Path&gt;" d="M2262.08,1307.17c-186.73,0-183.52,260.78-183.52,447.52s151.33,334.84,334.85,334.84c186.73,0,334.84-151.32,334.84-334.84C2751.47,1568,2445.6,1307.17,2262.08,1307.17Z"/>
            </g>
            <g class="pupils">
                <circle fill="#fff" cx="1122.9" cy="1902.88" r="90.24"/>
                <circle fill="#fff" cx="2313.9" cy="1902.88" r="90.24"/>
            </g>
            <g class="mouth">
                <path id="og-3" data-name="og" class="mouth-path" d="M1499.33,2326.51c68.62-150.15,334.2-171.14,415.73,1.61"/>
            </g>
        </svg>
    </div>

    <h1>Aww, looks like something went wrong.</h1>
    <p>We track these errors automatically, but if the problem persists feel free to contact us on <a href="mailto:support@enflow.nl">support@enflow.nl</a>. In the meantime, try refreshing.</p>

    <a href="https://enflow.nl" target="_blank" class="logo">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 786.07 180.78" width="130">
